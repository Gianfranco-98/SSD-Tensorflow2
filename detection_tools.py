...
def match_boxes(gt_boxes, pred_boxes, threshold=0.5):                 #TODO: CHECK CORRECTNESS
    ...
    pred_boxes: default boxes generated by predicted feature maps (Bounding_Box structures)
    ...
    if len(gt_boxes) == 0:                                          #TODO: With this trick loss = 0. Correct?
        for idx in range(len(pred_boxes)):
            ground_truth[idx] = Labeled_Box(
                bbox=pred_boxes[idx],
                label=0
            )
        return ground_truth
